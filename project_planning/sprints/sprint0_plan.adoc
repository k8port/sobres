...
If this sprint note conflicts, the canonical MVP doc takes precedence.
====
...
[IMPORTANT]
====
Onboarding and historical coverage are post-MVP.

Do not implement coverage calculations (including month counting and
`has_sufficient_history`) in MVP delivery.
====

=== Backend
[unordered]
* Deferred to post-MVP.
* Do not compute distinct-month coverage in MVP.
...
[unordered]
* Deferred to post-MVP.
* No onboarding prompt/progress implementation required for MVP.
...
== Sprint Plan
[horizontal]
**Sprint 1**:: *Persistence Foundation* [.small]#(1 week)#
* Configure database and tables
* User upload and parse statement workflows
...
* Compute historical % allocations from persisted transaction history
