...
[IMPORTANT]
====
Bills and reminders are post-MVP scope.

This sprint plan is retained as roadmap/backlog, not MVP delivery scope.
====
...
== Conclusion
Sprint 4 items are roadmap extensions after MVP completion.